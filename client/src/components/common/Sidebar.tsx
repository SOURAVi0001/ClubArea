...
import { Menu, X, Calendar, MessageSquare, Users, MessageCircle, ListTodo, UserPlus, ThumbsUp, Settings } from 'lucide-react';
import { useUIStore } from '@/stores/useUIStore';
import { useAuthStore } from '@/stores/useAuthStore';
import { ROUTES } from '@/utils/constants';

const sidebarLinks = [
  { to: ROUTES.LEADER, icon: Calendar, label: 'Dashboard' },
  ...
  { to: ROUTES.LEADER_TASKS, icon: ListTodo, label: 'Tasks' },
  { to: ROUTES.LEADER_RECRUITMENT, icon: UserPlus, label: 'Recruitment' },
